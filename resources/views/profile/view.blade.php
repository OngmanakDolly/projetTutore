							...
							<div class="col-lg-6">
								<div class="loadMore">
									...
									<div class="central-meta item">
										...
										<h5 class="f-title"><i class="ti-info-alt"></i> Profil</h5>
                                        
                                        @foreach($profil as $monProfil)
										<form>
                                        <div class="form-group">	
                                            <p></p>
											  <label class="control-label" for="input">Nom</label><br><i class="mtrl-select">{{getUserName($monProfil->user_id)}}</i>
											</div>
                                            <div class="form-group">	
                                            <p></p>
											  <label class="control-label" for="input">Email</label><br><i class="mtrl-select">{{getUserEmail($monProfil->user_id)}}</i>
											</div>
                                            <div class="form-group">	
                                            <p></p>
