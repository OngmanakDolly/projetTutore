    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">BetterliDays</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Vacancier</h6>
                        <a class="collapse-item" href="#">Ajouter</a>
                        <a class="collapse-item" href="{{ route('AdminViewVacanciers') }}">Consulter</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTables" class="collapse" aria-labelledby="headingTables" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Organisme</h6>
                        <a class="collapse-item" href="#">Ajouter</a>
                        <a class="collapse-item" href="{{ route('AdminViewOrganismes') }}">Consulter</a>
                    </div>
                 </div></li>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                             ...
                             <a class="dropdown-item d-flex align-items-center" href="#">
                                 ...
                                 <div>
                                     <div class="small text-gray-500">Decembre 12, 2022</div>
                                     <span class="font-weight-bold">Telecharger un rapport!</span>
                                 </div>
                             </a>
                             <a class="dropdown-item d-flex align-items-center" href="#">
                                 <div class="mr-3">
                             ...
                             <a class="dropdown-item d-flex align-items-center" href="#">
                                 ...
                                 <div>
                                     <div class="small text-gray-500">Avril 2, 2021</div>
                                     Une activité importante a ete remarque sur votre compte
                                 </div>
                             </a>
                         ...
                         <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                             ...
                             <a class="dropdown-item d-flex align-items-center" href="#">
                                 ...
                                 <div class="font-weight-bold">
                                     <div class="text-truncate">RAS</div>
                             ...
                             <a class="dropdown-item text-center small text-gray-500" href="#">Plus de messages</a>
                         </div>
                     </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; BetterllyDays 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
